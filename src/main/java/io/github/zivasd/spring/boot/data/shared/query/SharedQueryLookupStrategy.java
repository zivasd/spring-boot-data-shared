...
public final class SharedQueryLookupStrategy {
	...
	private abstract static class AbstractQueryLookupStrategy implements QueryLookupStrategy {
		...
		protected abstract RepositoryQuery resolveQuery(SharedQueryMethod method, EntityManager entityManager,
				NamedQueries namedQueries);
	}
	...
	private static class CreateQueryLookupStrategy extends AbstractQueryLookupStrategy {
		...
		@Override
		protected RepositoryQuery resolveQuery(SharedQueryMethod method, EntityManager entityManager,
				NamedQueries namedQueries) {
			return new NativeSharedQuery(method, entityManager);
		}
	}

	public static QueryLookupStrategy create(EntityManager entityManager, @Nullable Key key,
